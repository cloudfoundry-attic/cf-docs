# Deploy BOSH using micro BOSH on OpenStack. #

1. Deploy micro BOSH on OpenStack. See the steps in the previous section.
...
1. Download a public stemcell for OpenStack. *NOTE, in this case you do not use the micro bosh stemcell.*
